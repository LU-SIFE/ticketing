...
The [Discussions](https://github.com/LU-SIFE/Web-Dev-Ticketing/discussions) page can be used for students to converse, generate ideas, hold polls, ask questions, and show off work to other students.
